 ...
 * -----
 * File Description:
 * CLEO main program for EUREC4A 1-D column setup with condensation/evaporation and
 * collision-coalscence/breakup/rebound with number of fragments determined by the
 * collision kinetic energy ("coalbure_condensation_cke").
 */
